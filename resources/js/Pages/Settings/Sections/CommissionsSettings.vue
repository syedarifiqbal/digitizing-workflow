...
<template>
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="px-5 py-4 border-b border-gray-100">
            <h3 class="text-sm font-semibold text-gray-900">Commissions & Rewards</h3>
            <p class="mt-0.5 text-xs text-gray-500">Control when teams earn commissions, bonuses, and tips.</p>
        </div>
        <div class="px-5 py-4 space-y-4">
            <div>
                ...
                <p class="mt-1.5 text-xs text-gray-400">Choose when sales commission is considered earned.</p>
            ...
            <div>
                ...
                <p class="mt-1.5 text-xs text-gray-400">Define when designer bonuses are payable.</p>
            ...
            <div class="pt-2">
                ...
                <p class="mt-1.5 text-xs text-gray-400">
                    Allow admins to add optional tips for exceptional work when delivering orders.
                </p>
