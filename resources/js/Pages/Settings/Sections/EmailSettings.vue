    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        ...
        <div class="px-5 py-4 space-y-4">
            ...
            <div class="border-t border-gray-100 pt-4">
                <h4 class="text-sm font-medium text-gray-900">Sender Identity</h4>
                <p class="mt-0.5 text-xs text-gray-500">Override the default "From" address and name on outgoing emails.</p>
            </div>
