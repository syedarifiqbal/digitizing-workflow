    ...
    <div class="space-y-6">
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <div class="px-5 py-4 border-b border-gray-100">
                ...
                <p class="mt-0.5 text-xs text-gray-500">Company info and dashboard preferences.</p>
            </div>
            <div class="px-5 py-4 space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        <label class="block text-xs font-medium text-gray-700" for="name">Company Name</label>
                        <input
                            v-model="form.name"
                            id="name"
                            type="text"
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700" for="date_format">Date Format</label>
                        <select
