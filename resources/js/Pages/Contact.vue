            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-slate-50 rounded-lg p-8">
                    <div v-if="submitted" class="text-center py-8">
                        ...
                        <h2 class="text-2xl font-bold text-slate-900">Thank you!</h2>
                        <p class="mt-2 text-slate-500">We've received your message and will get back to you soon.</p>
                ...
                <div class="mt-12 grid gap-8 md:grid-cols-2">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-slate-500">support@digitizingworkflow.com</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-slate-900">Response Time</h3>
                        <p class="mt-2 text-slate-500">Within 24 hours</p>
                    </div>
                </div>
            </div>
        </div>
