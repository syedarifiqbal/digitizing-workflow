                            ...
                            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm font-medium text-gray-900 capitalize">{{ selectedTypeLabel }}</p>
                                    </div>
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <input v-model="form.height" id="height" type="text" placeholder="e.g. 3.5 or PROP" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                        ...
                                        <div>
                                            ...
                                            <input v-model="form.width" id="width" type="text" placeholder="e.g. 4.0 or PROP" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <select v-model="form.placement" id="placement" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <div>
                                            ...
                                            <select v-model="form.file_format" id="file_format" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <select v-model="form.patch_type" id="patch_type" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <div>
                                            ...
                                            <input v-model.number="form.quantity" id="quantity" type="number" min="1" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <input v-model="form.height" id="patch_height" type="text" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                            <p v-if="form.errors.height" class="mt-1 text-xs text-red-600">{{ form.errors.height }}</p>
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700" for="patch_width">Width (inches)</label>
                                            <input v-model="form.width" id="patch_width" type="text" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                            <p v-if="form.errors.width" class="mt-1 text-xs text-red-600">{{ form.errors.width }}</p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <select v-model="form.backing" id="backing" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <div>
                                            ...
                                            <select v-model="form.placement" id="patch_placement" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                                <option value="">Select placement</option>
                                                <option v-for="p in fieldOptions.placements" :key="p" :value="p">{{ p }}</option>
                                            </select>
                                            <p v-if="form.errors.placement" class="mt-1 text-xs text-red-600">{{ form.errors.placement }}</p>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                        <div>
                                            ...
                                            <select v-model="form.merrow_border" id="merrow_border" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <div>
                                            ...
                                            <input v-model.number="form.num_colors" id="num_colors" type="number" min="0" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                        ...
                                        <div>
                                            ...
                                            <select v-model="form.fabric" id="fabric" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700" for="shipping_address">Shipping Address</label>
                                        <textarea v-model="form.shipping_address" id="shipping_address" rows="2" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <select v-model="form.color_type" id="color_type" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <div>
                                            ...
                                            <input v-model.number="form.num_colors" id="vector_num_colors" type="number" min="0" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                            <p v-if="form.errors.num_colors" class="mt-1 text-xs text-red-600">{{ form.errors.num_colors }}</p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <select v-model="form.vector_order_type" id="vector_order_type" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <div>
                                            ...
                                            <select v-model="form.required_format" id="required_format" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                                <option value="">Select format</option>
                            ...
                            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    ...
                                    <div v-if="files?.length">
                                        <label class="block text-xs font-medium text-gray-700 mb-2">Current Files</label>
                                        <div class="divide-y divide-gray-100 rounded-md border border-gray-200">
                                            <div v-for="file in files" :key="file.id" class="flex items-center justify-between px-3 py-2">
                                                <div>
                                                    ...
                                                    <p class="text-xs text-gray-500">{{ formatSize(file.size) }} <span class="ml-1 uppercase text-gray-400">{{ file.type }}</span></p>
                                                </div>
                                                <button type="button" class="p-1.5 rounded text-gray-400 hover:text-red-600 hover:bg-red-50" @click="openDeleteModal(file)" title="Delete">
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700" for="attachments">Add More Files</label>
                                        <p class="mt-0.5 text-xs text-gray-400">Max {{ maxUploadMb }}MB per file.</p>
                                        <input
                                            id="attachments"
                                            type="file"
                                            multiple
                            ...
                            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    <div>
                                        ...
                                        <input v-model="form.price_amount" id="price_amount" type="number" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                                    ...
                                    <div>
                                        ...
                                        <input v-model="form.currency" id="currency" type="text" maxlength="3" class="mt-1 block w-32 rounded-md border-gray-300 text-sm shadow-sm uppercase focus:border-indigo-500 focus:ring-indigo-500" />
                            ...
                            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                                ...
                                <div class="px-5 py-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input v-model="form.source" id="source" type="text" placeholder="Website, phone, API..." class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
