    ...
    <AppLayout>
        <template #header>
            <div class="flex flex-col gap-1">
                <h2 class="text-lg font-semibold text-gray-900">Create Order</h2>
                <p class="text-sm text-gray-500">Submit a new order for processing.</p>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-5 py-6 space-y-6">
                        ...
                        <!-- Input Files -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Artwork Files *</label>
                            <p class="mt-1 text-xs text-gray-500">
                                Allowed extensions: {{ allowedInputExtensions.join(', ') }} | Max size: {{ maxUploadMb }}MB per file
                            </p>
                            <input
                            ...
                            />
                            <p v-if="form.input_files.length > 0" class="mt-2 text-sm text-gray-600">
